...
class demonative: UIViewController, TKAdNativeDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.myAdNative = TKAdNative.init(place: "bc47b614-7b24-4eb1-aae2-65e8de8e96de", category: "CATEGORIES")
...
extension demonative: TKAdNativeDelegate {
